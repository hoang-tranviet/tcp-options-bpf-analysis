...
def plot_box_graph():
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(exp_dir + 'overhead-tput-max.pdf')
    plt.savefig(exp_dir + 'overhead-tput-max.png')
    ...
    plt.savefig(exp_dir + 'overhead-rtt-max.pdf')
    plt.savefig(exp_dir + 'overhead-rtt-max.png')
    ...
    plt.savefig(exp_dir + 'overhead-local-cpu-max.pdf')
    plt.savefig(exp_dir + 'overhead-local-cpu-max.png')
    ...
    plt.savefig(exp_dir + 'overhead-remote-cpu-max.pdf')
    plt.savefig(exp_dir + 'overhead-remote-cpu-max.png')
